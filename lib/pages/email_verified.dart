    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          const OrangeGlow(
              top: -110,
              left: -100), // Custom widget for an orange glow at the top-left.
          const OrangeGlow(
              top: 650, left: 250), // Another orange glow at the bottom-right.
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color.fromARGB(
                    178, 0, 0, 0), // Semi-transparent black background.
          ...
          Positioned(
            ...
            child: Container(
              width:
                  screenSize.width * 0.85, // Same width as the first container.
              height: screenSize.height * 0.250,
              padding: EdgeInsets.all(screenSize.width * 0.05),
              decoration: BoxDecoration(
                color: const Color.fromARGB(
                    64, 0, 0, 0), // More transparent black background.
                borderRadius: BorderRadius.circular(12),
              ),
              child: Column(
                // Column to arrange text and button vertically.
                mainAxisAlignment:
                    MainAxisAlignment.center, // Centering items in the column.
                children: [
                  ...
                  SizedBox(
                      height:
                          screenSize.height * 0.08), // Space before the button.
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor:
                            const Color(0xFFE76F04), // Orange background color.
