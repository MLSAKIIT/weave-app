                    ...
                    child: Container(
                      ...
                      child: Column(
                        mainAxisSize: MainAxisSize
                            .min, // To tightly wrap all the child to center without using extra space
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                                ...
                                decoration: TextDecoration
                                    .none // To remove the yellow lines coming on text
                                ),
                          ),
                          InkWell(
                            onTap:
                                () {}, // Reconnect Button - On Click or On Tap
                            child: Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: Image.asset(
                                  'assets/icons/ReconnectButton.png',
                                ),
                              ),
                            ),
                          ),
