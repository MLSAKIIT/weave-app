        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                // Column to arrange text and icon vertically.
                ...
                children: [
                  ...
                  const SizedBox(
                      height: 5), // Small spacing between the two text lines.
                  ...
                  SizedBox(
                      height: screenSize.height *
                          0.04), // Space before the check icon.

                  // Checkmark icon to indicate success.
                  const Icon(Icons.check_circle,
                      color: Color(0xFFE76F04), size: 35),
                ],
              ),
            ),
          ),
